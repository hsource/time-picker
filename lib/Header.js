  ...
  function Header(props) {
    ...
    _this.onInputChange = function (event) {
      ...
      var _this$props = _this.props,
          passedInFormat = _this$props.format,
          validFormats = _this$props.validFormats,
      ...
      if (str) {
        ...
        var format = (validFormats === null || validFormats === void 0 ? void 0 : validFormats.find(function (format) {
          var result = (0, _moment.default)(str, format, true).isValid();
          return result;
        })) || passedInFormat;
